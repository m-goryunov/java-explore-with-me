...
import ru.practicum.event.dto.EventShortWithViewsDto;
...
public class EventControllerPublic {
    ...
    @GetMapping
    public List<EventShortWithViewsDto> getEvents(@RequestParam(required = false) String text,
    ...
    @GetMapping("/{eventId}")
    public EventWithViewsDto getEventById(@PathVariable Long eventId, HttpServletRequest request) {
